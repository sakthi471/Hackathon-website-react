      ...
      <div className=" flex w-full items-center justify-center h-[500px] pt-28   lg:gap-6 xl:pt-0">
        ...
        <div className="px-4 py-7 flex flex-col  jutstify-center  gap-8 ">
          ...
          <div className=" 2xl: flex 2xl:gap-6 flex-col  gap-6 md:flex-row ">
            <Link to='/register' ><button className="box px-8 py-2  bg-violet-600 rounded-lg font-bold w-[320px]  xl:text-xl xl:py-3" >Register</button>
            </Link>
            <ScrollLink to="hackathon" smooth={true} duration={500} offset={-50} >   <button className="box px-8 py-2 rounded-lg bg-purple-500 font-bold w-[320px] xl:text-xl xl:py-3 2xl:w-[250px] md:w-[200px]" >Hackathon</button>
            </ScrollLink>
