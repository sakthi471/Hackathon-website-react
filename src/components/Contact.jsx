  ...
  return (
    <div  name="contact" className='w-full min-h-[300px] flex  items-center justify-center footerGradient'>
      <div className='w-full flex flex-col justify-evenly  gap-14 px-10 py-9 md:w-[60%] lg:flex-row lg:px-2 lg:w-full  xl:flex-row xl:justify-evenly xl:w-full '>
        ...
        <div className='flex flex-col gap-5'>
          ...
          <div className=' flex flex-col gap-3' >
            <div>
              ...
              <p className='  font-semibold hover:border-blue-400 hover:border-b-2  cursor-pointer'>Contact@madurai-tech.org
            ...
            <div>
              ...
              <p className=' font-semibold hover:border-blue-400 hover:border-b-2  cursor-pointer'> Sponsor@madurai-tech.org
        ...
        <div className=' flex  flex-col gap-5'>
          <p className='capitalize text-xl font-bold  border-blue-400 border-b-2 w-[150px]'>usefull links</p>
          <div className=' flex flex-col gap-1'>
            <p className=' capitalize hover:border-blue-400 hover:border-b-2  cursor-pointer '>about us</p>
            <p className=' capitalize hover:border-blue-400 hover:border-b-2  cursor-pointer '>sponers us</p>
          </div>
        </div>
