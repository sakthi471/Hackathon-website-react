      ...
      <div className="p-4 flex gap-11 w-full flex-wrap items-center justify-center xl:gap-40 2xl:gap-14 2xl:h-[600px] ">
        {
          tracks.map(({ id, title, desc, img }) => (
            <div key={id} className=" tracksShadow w-[350px] 2xl:h-[330px] 2xl:hover:h-[550px] duration-700 overflow-hidden relative liner-border p-[3px] rounded-[15px] md:w-[450px] xl:w-[450px] 2xl:w-[400px] ">
