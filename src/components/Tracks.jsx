...
const Tracks = () => {
  ...
  return (
    <div className="w-full px-5 h-screen flex flex-col items-center py-5">
      <h2 className="font-bold text-4xl py-7 ">Tracks</h2>
      <div className="p-4 flex gap-6 w-full flex-wrap items-center justify-center">
        {
          tracks.map( ({id,title,desc,img})=>(
            <div key={id} className="  w-[330px] relative liner-border p-[2px] rounded-[20px]">
            <div className=" h-[500px] px-4 py-4 bg-tertiary rounded-[20px] shadow-card flex flex-col  gap-5">
