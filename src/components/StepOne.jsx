    ...
    <div className="flex justify-center">
      <form className="w-[90%]">
        <div className="flex flex-col py-1">
          <label className=" text-gray-300 capitalize" htmlFor="team_name" >Team Name</label>
          <input className=" rounded-sm bg-slate-200 px-2 py-1 text-black focus:outline-blue-700 focus:outline-3 outline-none border-none" type="text" name="" id="team_name" />
        </div>
        <div className="flex flex-col py-1" >
